...
class ViewController: UIViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.tf.enablesReturnKeyAutomatically = true // 텍스트 필드에 값이 비어 있을 때에는 리턴 키를 비활성화
    ...
    // 텍스트필드의 내용이 변경될 때 호출 -> 이 메소드의 반환값에 따라 편집 내용이 텍스트 필드에 반영되기도, 반영되지 않기도 한다. 이를 응용하면 특정 문자열을 입력 차단하거나 제어할 수 있음.
